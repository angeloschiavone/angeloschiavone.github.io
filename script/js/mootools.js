...
// MooTools: the javascript framework.
// Load this file's selection again by visiting: http://mootools.net/more/cca3444eeeb836acbb73ca1a4c4759f3 
// Or build this file again with packager using: packager build More/Date More/Date.Extras More/String.QueryString More/Element.Pin More/Fx.Accordion More/Fx.Move More/Fx.Reveal More/Fx.Scroll More/Fx.Slide More/Fx.SmoothScroll More/Assets More/Locale More/Locale.en-GB.Date More/Locale.it-IT.Date More/Locale.it-IT.Form.Validator
/*
---
copyrights:
  - [MooTools](http://mootools.net)
...
return a?a.call(null,c,d):(d||d===0);}).join("&");}});(function(){var a=false,b=false;var c=function(){var d=new Element("div").setStyles({position:"fixed",top:0,right:0}).inject(document.body);
...
}return this;},unpin:function(){return this.pin(false);},togglePin:function(){return this.pin(!this.retrieve("pin:_pinned"));}});})();Fx.Elements=new Class({Extends:Fx.CSS,initialize:function(b,a){this.elements=this.subject=$$(b);
